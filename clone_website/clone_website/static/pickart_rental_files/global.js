...
function callIframeParentFunction_changeItemHeight(itemId) {
	...
	$(".item-element").children().each(function() {
		itemHeight += $(this).height()+require("common/common").getPureNumber($(this).css("margin-top"))+require("common/common").getPureNumber($(this).css("margin-bottom"));
	});
	
	if(parent.changeItemHeight) {
...
function sendFocusedElementInformation(startElementAncestorList, endElementAncestorList) {
	require("editor/view").handleController.showElementController({startElementAncestorList : startElementAncestorList, endElementAncestorList : endElementAncestorList});
}
...
//	$("#filter_allShopProduct").trigger('click');
...
function closeShopCustomerDetail() {
	...
	$("body").css({overflow:"auto"});
//	$("#filter_allShopProduct").trigger('click');
	$("#iframe_shopCustomerDetail").remove(); 
}
...
function callIframeParentFunction_getShopOrdersByMemberNoAndOrderStatus(memberNo, pageNo, orderStatus) {
	if(parent.getShopOrdersByMemberNoAndOrderStatus) {
		return parent.getShopOrdersByMemberNoAndOrderStatus(memberNo, pageNo, orderStatus);
	}
}
function getShopOrdersByMemberNoAndOrderStatus(memberNo, pageNo, orderStatus) {
	require("userHome/get").getShopOrdersByMemberNoAndOrderStatus(memberNo, pageNo, orderStatus);
...
function reloadUserHomePage(type) {
	if(type == "shopCustomer") {
		require("userHome/get").getShopCustomersByCustomerGradeWithSearchKeyword($("#data_div").attr("data-memberNo"), require("common/common").getParameterByName("customerGrade"), require("common/common").getParameterByName("searchKeyword"),
				require("common/common").getParameterByName("filter"), require("common/common").getParameterByName("page"), require("common/common").getParameterByName("npp"));
	}
}
